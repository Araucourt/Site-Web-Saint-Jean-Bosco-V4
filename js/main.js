/* ============================================================
   ÉCOLE SAINT JEAN BOSCO — main.js
   Comportements globaux : nav mobile, carousel, collapsible, FAQ
   ============================================================ */
...
function initCarousel() {
  ...
  function updateCarousel() {
    ...
    const gap     = 20; // px — correspond au gap: 1.25rem ~= 20px
